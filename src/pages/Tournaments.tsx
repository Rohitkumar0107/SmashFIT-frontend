    ...
    <div className="max-w-7xl mx-auto py-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4 bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xs sm:text-sm md:text-base text-slate-500 font-medium mt-2">
            Find and register for the best badminton events around you.
          </p>
        </div>
        ...
        <div className="relative w-full md:w-80 z-10">
          <Search 
            size={18}
            className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 sm:w-5 sm:h-5"
          />
          <input 
            type="text" 
          ...
          {filteredTournaments.map((tournament) => (
            ...
            >
              ...
              <div className="h-40 w-full bg-slate-100 relative overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-white/95 px-3 py-1.5 rounded-lg shadow-sm">
              ...
              <div className="p-6 flex flex-col flex-1 relative">
                ...
                <div className="mt-6 pt-5 border-t border-slate-100 flex items-center justify-between">
                  <div className="text-xs font-bold text-amber-600 bg-amber-50 px-3 py-1.5 rounded-lg">
        ...
        <div className="text-center py-24 bg-white rounded-3xl border-2 border-dashed border-slate-200">
          ...
          <p className="text-slate-500 font-medium mt-2">
            {searchQuery 
              ...
              : "There are no live tournaments right now. Check back later!"
            }
          </p>
        </div>
      )}
