    ...
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-20 bg-white p-8 rounded-xl shadow-2xl w-96 backdrop-blur-sm bg-white/95">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button type="submit" className="w-full bg-blue-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-700 transition duration-200 shadow-md hover:shadow-lg">
            Sign In
          </button>
        </form>
        ...
        <div className="mt-6">
          ...
          <div className="flex justify-center">
            <GoogleLogin onSuccess={handleGoogleSuccess} onError={() => setError('Google Login Widget Failed')} useOneTap />
          </div>
        </div>
